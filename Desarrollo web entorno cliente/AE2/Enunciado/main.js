        ...
        .then(data => {
            ...
            for (let index = 0; index < 3; index++) {
               ...
               let imagen= document.getElementsByClassName("item-0")[index];
                ...
                document.getElementsByClassName("item-1")[index].innerHTML=personajes[index].gender;
                document.getElementsByClassName("item-2")[index].innerHTML=personajes[index].species;
                document.getElementsByClassName("item-3")[index].innerHTML=personajes[index].name;
                document.getElementsByClassName("item-4")[index].innerHTML=personajes[index].status;
